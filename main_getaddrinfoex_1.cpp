// demonstrates how to use the GetAddrInfoEx function asynchronous to resolve a name to an IP address.
...
int __cdecl wmain_getaddrinfoex_1(int argc, wchar_t ** argv)
{
